...
* **misconf:** use ID instead of AVDID for providers mapping ([#9752](https://github.com/aquasecurity/trivy-release-test/issues/9752))

### Features

* **activestate:** add support ActiveState images ([#10081](https://github.com/aquasecurity/trivy-release-test/issues/10081)) ([676709d](https://github.com/aquasecurity/trivy-release-test/commit/676709de44639e6c4329e1c69ee34a5e2760555f))
* add AnalyzedBy field to track which analyzer detected packages ([#10059](https://github.com/aquasecurity/trivy-release-test/issues/10059)) ([1953824](https://github.com/aquasecurity/trivy-release-test/commit/195382400fc9bf93cf303910453d44f6ba3b5dad))
* add ArtifactID field to uniquely identify scan targets ([#9663](https://github.com/aquasecurity/trivy-release-test/issues/9663)) ([84a7d9a](https://github.com/aquasecurity/trivy-release-test/commit/84a7d9a5d6880ef4248ead6bcf2e580deed9107b))
* add Bottlerocket OS package analyzer ([#8653](https://github.com/aquasecurity/trivy-release-test/issues/8653)) ([07ef63b](https://github.com/aquasecurity/trivy-release-test/commit/07ef63b4830f9f3d791a07433287a99118d7590a))
* add documentation URL for database lock errors ([#9531](https://github.com/aquasecurity/trivy-release-test/issues/9531)) ([eba48af](https://github.com/aquasecurity/trivy-release-test/commit/eba48afd583391cef346e45a176aa5a6d77b704f))
* add graceful shutdown with signal handling ([#9242](https://github.com/aquasecurity/trivy-release-test/issues/9242)) ([2c05882](https://github.com/aquasecurity/trivy-release-test/commit/2c05882f45071928c14d8212ef6c4f0f7048245d))
* add HTTP request/response tracing support ([#9125](https://github.com/aquasecurity/trivy-release-test/issues/9125)) ([aa5b32a](https://github.com/aquasecurity/trivy-release-test/commit/aa5b32a19f4d61d0df72c11fd314c5a0b7284202))
* add ReportID field to scan reports ([#9670](https://github.com/aquasecurity/trivy-release-test/issues/9670)) ([fc976be](https://github.com/aquasecurity/trivy-release-test/commit/fc976bea480599e52365d306ad8d6031718d4303))
* add timeout handling for cache database operations ([#9307](https://github.com/aquasecurity/trivy-release-test/issues/9307)) ([235c24e](https://github.com/aquasecurity/trivy-release-test/commit/235c24e71a546b6196f7264fced2d02d836e3f85))
* allow ignoring findings by type in Rego ([#9578](https://github.com/aquasecurity/trivy-release-test/issues/9578)) ([c638fc6](https://github.com/aquasecurity/trivy-release-test/commit/c638fc646c3c0d56ea50c830a31609badb477c5e))
* **alma:** add AlmaLinux 10 support ([#9207](https://github.com/aquasecurity/trivy-release-test/issues/9207)) ([861d51e](https://github.com/aquasecurity/trivy-release-test/commit/861d51e99a45ee448f86fe195dedcaefb811c919))
* **alpine:** add maintainer field extraction for APK packages ([#8930](https://github.com/aquasecurity/trivy-release-test/issues/8930)) ([104bbc1](https://github.com/aquasecurity/trivy-release-test/commit/104bbc18ea85caec17125296dc4fe2dea9c49826))
* **aws:** Add support for dualstack ECR endpoints ([#9862](https://github.com/aquasecurity/trivy-release-test/issues/9862)) ([e74e2b1](https://github.com/aquasecurity/trivy-release-test/commit/e74e2b1b0a8ca124b1299969abc9196789f30e8b))
* **cli:** Add available version checking ([#8553](https://github.com/aquasecurity/trivy-release-test/issues/8553)) ([5a0bf9e](https://github.com/aquasecurity/trivy-release-test/commit/5a0bf9ed31ad34248895e69231da602935e66785))
* **cli:** Add trivy cloud suppport ([#9637](https://github.com/aquasecurity/trivy-release-test/issues/9637)) ([8e6a7ff](https://github.com/aquasecurity/trivy-release-test/commit/8e6a7ff670c64106d4dea6972ac3f6228f9c6269))
* **cli:** add version constraints to annoucements ([#9023](https://github.com/aquasecurity/trivy-release-test/issues/9023)) ([19efa9f](https://github.com/aquasecurity/trivy-release-test/commit/19efa9fd372242d2ec582a248e9e6573d2caef00))
* **cli:** change --list-all-pkgs default to true ([#9510](https://github.com/aquasecurity/trivy-release-test/issues/9510)) ([7b663d8](https://github.com/aquasecurity/trivy-release-test/commit/7b663d86ca65ee3eb332c857b77bfa18e6da56c4))
* **cloudformation:** add support for Fn::ForEach ([#9508](https://github.com/aquasecurity/trivy-release-test/issues/9508)) ([d65b504](https://github.com/aquasecurity/trivy-release-test/commit/d65b504cb24a4d71f054bfbd6a872b58385bb0d3))
* **cloudformation:** support default values and list results in Fn::FindInMap ([#9515](https://github.com/aquasecurity/trivy-release-test/issues/9515)) ([42b3bf3](https://github.com/aquasecurity/trivy-release-test/commit/42b3bf37bb7d39139911843297c8b8ab3551c31a))
* **cyclonedx:** preserve SBOM structure when scanning SBOM files with vulnerability updates ([#9439](https://github.com/aquasecurity/trivy-release-test/issues/9439)) ([aff03eb](https://github.com/aquasecurity/trivy-release-test/commit/aff03ebab2e7874dd997e20b4ec9962a41eae7bb))
* **db:** enable concurrent access to vulnerability database ([#9750](https://github.com/aquasecurity/trivy-release-test/issues/9750)) ([d70d994](https://github.com/aquasecurity/trivy-release-test/commit/d70d994d8882a6e7a8b0c9a9b08524a2cae32ea4))
* **debian:** detect third-party packages using maintainer list ([#9917](https://github.com/aquasecurity/trivy-release-test/issues/9917)) ([effc1c0](https://github.com/aquasecurity/trivy-release-test/commit/effc1c0d4d46e01efa896f53ccc72eb87d175d91))
* **dotnet:** add dependency graph support for .deps.json files ([#9726](https://github.com/aquasecurity/trivy-release-test/issues/9726)) ([18c0ee8](https://github.com/aquasecurity/trivy-release-test/commit/18c0ee86f318c7d2b1dab979370f62dd00b73979))
* **echo:** Add Echo Support ([#8833](https://github.com/aquasecurity/trivy-release-test/issues/8833)) ([c7b8cc3](https://github.com/aquasecurity/trivy-release-test/commit/c7b8cc392eb28eb63e10561cf1ff7991e5e3c548))
* **flag:** add `--cacert` flag ([#9781](https://github.com/aquasecurity/trivy-release-test/issues/9781)) ([6048173](https://github.com/aquasecurity/trivy-release-test/commit/604817326683cdf5628550540aef63b97affc3b0))
* **flag:** add JSON Schema for trivy.yaml configuration file ([#9971](https://github.com/aquasecurity/trivy-release-test/issues/9971)) ([4caf731](https://github.com/aquasecurity/trivy-release-test/commit/4caf7312b63f93024c188f243cda957d97b30a88))
* **flag:** add schema validation for `--server` flag ([#9270](https://github.com/aquasecurity/trivy-release-test/issues/9270)) ([ed4640e](https://github.com/aquasecurity/trivy-release-test/commit/ed4640ec27f2575a50d7e6d516c9e2e45a59bb7f))
* **fs:** change artifact type to repository when git info is detected ([#9613](https://github.com/aquasecurity/trivy-release-test/issues/9613)) ([cff91ac](https://github.com/aquasecurity/trivy-release-test/commit/cff91acdef91fbce22306a72000c43a26ac8d79b))
* **go:** detect version from ELF symbol table for binaries built with -trimpath ([#10197](https://github.com/aquasecurity/trivy-release-test/issues/10197)) ([7acb5f6](https://github.com/aquasecurity/trivy-release-test/commit/7acb5f6f095a11cb9911af5a0bc03aecc7c88f8f))
* **helm:** add sslCertDir parameter ([#9697](https://github.com/aquasecurity/trivy-release-test/issues/9697)) ([879e4fc](https://github.com/aquasecurity/trivy-release-test/commit/879e4fca12b53010e3b6a22fcb9c6e2b8eefad96))
* **image:** add Docker context resolution ([#9166](https://github.com/aquasecurity/trivy-release-test/issues/9166)) ([99cd4e7](https://github.com/aquasecurity/trivy-release-test/commit/99cd4e776c0c6cc689126e53fa86ee6333ba6277))
* **image:** add RepoTags support for Docker archives ([#9690](https://github.com/aquasecurity/trivy-release-test/issues/9690)) ([a9a3031](https://github.com/aquasecurity/trivy-release-test/commit/a9a3031675150e70a32df8d55b4aec2c4a33084b))
* **image:** add Sigstore bundle SBOM support ([#9516](https://github.com/aquasecurity/trivy-release-test/issues/9516)) ([e1f3f28](https://github.com/aquasecurity/trivy-release-test/commit/e1f3f28ae4b86dd7f518a261080dc8d24ac2cdad))
* **image:** pass global context to docker/podman image save func ([#9733](https://github.com/aquasecurity/trivy-release-test/issues/9733)) ([2690ac9](https://github.com/aquasecurity/trivy-release-test/commit/2690ac99341dcdf06eb16316d3ca20e6070969b3))
* include registry and repository in artifact ID calculation ([#9689](https://github.com/aquasecurity/trivy-release-test/issues/9689)) ([758f271](https://github.com/aquasecurity/trivy-release-test/commit/758f2710403d5f0e9b3e138a604f95cbcab6f275))
* **java:** add support for proxy configuration from Maven settings.xml ([#10187](https://github.com/aquasecurity/trivy-release-test/issues/10187)) ([350fe33](https://github.com/aquasecurity/trivy-release-test/commit/350fe3345129f0f341ab80438f66f951b602364a))
* **java:** add support remote repositories from settings.xml files ([#9708](https://github.com/aquasecurity/trivy-release-test/issues/9708)) ([eff52eb](https://github.com/aquasecurity/trivy-release-test/commit/eff52eb2e60a700d831cbc3d260217162b38e45c))
* **java:** dereference all maven settings.xml env placeholders ([#9024](https://github.com/aquasecurity/trivy-release-test/issues/9024)) ([5aade69](https://github.com/aquasecurity/trivy-release-test/commit/5aade698c71450badf8db028be61e12ec85c6248))
* **julia:** enable vulnerability scanning for the Julia language ecosystem ([#9800](https://github.com/aquasecurity/trivy-release-test/issues/9800)) ([c2f82ad](https://github.com/aquasecurity/trivy-release-test/commit/c2f82add3a59a509f581cc245630ce29e801de6a))
* **k8s:** get components from namespaced resources ([#8918](https://github.com/aquasecurity/trivy-release-test/issues/8918)) ([4f1ab23](https://github.com/aquasecurity/trivy-release-test/commit/4f1ab238693919772a65450de9fb9fb2f873c0d6))
* **license:** improve work text licenses with custom classification ([#8888](https://github.com/aquasecurity/trivy-release-test/issues/8888)) ([ee52230](https://github.com/aquasecurity/trivy-release-test/commit/ee522300b73a2afc72829fc2fa7ff419712fc89a))
* **license:** improve work with custom classification of licenses from config file ([#8861](https://github.com/aquasecurity/trivy-release-test/issues/8861)) ([c321fdf](https://github.com/aquasecurity/trivy-release-test/commit/c321fdfcdd58f34d076fc730e2b63fdd13e426a9))
* **license:** observe pkg types option in license scanner ([#9091](https://github.com/aquasecurity/trivy-release-test/issues/9091)) ([d44af8c](https://github.com/aquasecurity/trivy-release-test/commit/d44af8cfa21a145d14ca6e5e1ed4742d892f2dc5))
* **license:** Support compound licenses (licenses using SPDX operators) ([#8816](https://github.com/aquasecurity/trivy-release-test/issues/8816)) ([39f9ed1](https://github.com/aquasecurity/trivy-release-test/commit/39f9ed128b2c0fb599ad9092a3cf5675106bffdc))
* **license:** use separate SPDX ids to ignore SPDX expressions ([#9087](https://github.com/aquasecurity/trivy-release-test/issues/9087)) ([012f3d7](https://github.com/aquasecurity/trivy-release-test/commit/012f3d75359e019df1eb2602460146d43cb59715))
* **minimos:** Add support for MinimOS ([#8792](https://github.com/aquasecurity/trivy-release-test/issues/8792)) ([c2dde33](https://github.com/aquasecurity/trivy-release-test/commit/c2dde33c3f19d499258a7089d7658a9f90722acf))
* **misconf:** adapt ARM k8s clusters ([#9696](https://github.com/aquasecurity/trivy-release-test/issues/9696)) ([#10125](https://github.com/aquasecurity/trivy-release-test/issues/10125)) ([66bdec4](https://github.com/aquasecurity/trivy-release-test/commit/66bdec4f6af6100b6ab991ca417b0c801cb5cd80))
* **misconf:** add action block to Terraform schema ([#10035](https://github.com/aquasecurity/trivy-release-test/issues/10035)) ([b06ef6d](https://github.com/aquasecurity/trivy-release-test/commit/b06ef6d2706fddb5b9c5bc42c7d26598eb105f28))
* **misconf:** add agentpools to azure container schema ([#9714](https://github.com/aquasecurity/trivy-release-test/issues/9714)) ([69f400c](https://github.com/aquasecurity/trivy-release-test/commit/69f400c1839cc16013f2af3d1942c86f496e7017))
* **misconf:** add OpenTofu file extension support ([#8747](https://github.com/aquasecurity/trivy-release-test/issues/8747)) ([57801d0](https://github.com/aquasecurity/trivy-release-test/commit/57801d0324384d990889ba39d856c881e5b8b070))
* **misconf:** add private ip google access attribute to subnetwork ([#9199](https://github.com/aquasecurity/trivy-release-test/issues/9199)) ([263845c](https://github.com/aquasecurity/trivy-release-test/commit/263845cfc1419401f24adc8bc6316f3ea0caacad))
* **misconf:** Add RoleAssignments attribute ([#9396](https://github.com/aquasecurity/trivy-release-test/issues/9396)) ([3fb8703](https://github.com/aquasecurity/trivy-release-test/commit/3fb8703f8cd659a36d6a9affe0d2e20cd752a1e4))
* **misconf:** Add support for `Minimum Trivy Version` ([#8880](https://github.com/aquasecurity/trivy-release-test/issues/8880)) ([3b2a397](https://github.com/aquasecurity/trivy-release-test/commit/3b2a3976ac7e7785828655903b132e84ebd9d727))
* **misconf:** Add support for configurable Rego error limit ([#9657](https://github.com/aquasecurity/trivy-release-test/issues/9657)) ([445cd2b](https://github.com/aquasecurity/trivy-release-test/commit/445cd2b6b4faf78349245bc6541176e2fbf88715))
* **misconf:** added audit config attribute ([#9249](https://github.com/aquasecurity/trivy-release-test/issues/9249)) ([4d4a244](https://github.com/aquasecurity/trivy-release-test/commit/4d4a2444b692512aca137dcbd367ff224fe25597))
* **misconf:** added logging and versioning to the gcp storage bucket ([#9226](https://github.com/aquasecurity/trivy-release-test/issues/9226)) ([110f80e](https://github.com/aquasecurity/trivy-release-test/commit/110f80ea29951863997dd5a1c48fe14eb81e230b))
* **misconf:** export raw Terraform data to Rego ([#8741](https://github.com/aquasecurity/trivy-release-test/issues/8741)) ([aaecc29](https://github.com/aquasecurity/trivy-release-test/commit/aaecc29e909db4d5dac03caa0daf223035bfb877))
* **misconf:** include map key in manifest snippet for diagnostics ([#9681](https://github.com/aquasecurity/trivy-release-test/issues/9681)) ([197c9e1](https://github.com/aquasecurity/trivy-release-test/commit/197c9e1dce450737fc705184eed4c24fcfc1ecc1))
* **misconf:** initial ansible scanning support ([#9332](https://github.com/aquasecurity/trivy-release-test/issues/9332)) ([9275e15](https://github.com/aquasecurity/trivy-release-test/commit/9275e1532b11c5f1842f334660303a7ebf46a2c6))
* **misconf:** normalize CreatedBy for buildah and legacy docker builder ([#8953](https://github.com/aquasecurity/trivy-release-test/issues/8953)) ([65e155f](https://github.com/aquasecurity/trivy-release-test/commit/65e155fdaf0ad02ec82f00a004427f126faf65ed))
* **misconf:** resolve Azure resources via resource_id ([#10173](https://github.com/aquasecurity/trivy-release-test/issues/10173)) ([823f363](https://github.com/aquasecurity/trivy-release-test/commit/823f3634ae8f41a17be8695ceabcb8ca52f82a63))
* **misconf:** support for ARM resources defined as an object ([#9959](https://github.com/aquasecurity/trivy-release-test/issues/9959)) ([92d3465](https://github.com/aquasecurity/trivy-release-test/commit/92d3465cee297cad6f6e1efbb4597676e081c275))
* **misconf:** support for azurerm_*_web_app ([#9944](https://github.com/aquasecurity/trivy-release-test/issues/9944)) ([37b5da8](https://github.com/aquasecurity/trivy-release-test/commit/37b5da895bcac45a617fee00f9de2bececb3b26a))
* **misconf:** support for azurerm_network_interface_security_group_association  ([#10215](https://github.com/aquasecurity/trivy-release-test/issues/10215)) ([da94d5f](https://github.com/aquasecurity/trivy-release-test/commit/da94d5f38676885264787fe22f3ed8ab42511b2a))
* **misconf:** support https_traffic_only_enabled in Az storage account ([#9784](https://github.com/aquasecurity/trivy-release-test/issues/9784)) ([c8d5ab7](https://github.com/aquasecurity/trivy-release-test/commit/c8d5ab7690b63a0af14d648eacabc62b868fdfe9))
* **misconf:** Update AppService schema ([#9792](https://github.com/aquasecurity/trivy-release-test/issues/9792)) ([c6d95d7](https://github.com/aquasecurity/trivy-release-test/commit/c6d95d7cd271c3d29ce147f1ad5983cafc1caf48))
* **misconf:** Update Azure Compute schema ([#9675](https://github.com/aquasecurity/trivy-release-test/issues/9675)) ([cb58bf6](https://github.com/aquasecurity/trivy-release-test/commit/cb58bf639eaea0a94584b4afbefe19d0010eef38))
* **misconf:** Update Azure Container Schema ([#9673](https://github.com/aquasecurity/trivy-release-test/issues/9673)) ([43a7546](https://github.com/aquasecurity/trivy-release-test/commit/43a7546d31f2cc8dd5f8d68f82822aff1bddc4d2))
* **misconf:** Update Azure Database schema ([#9811](https://github.com/aquasecurity/trivy-release-test/issues/9811)) ([48dfede](https://github.com/aquasecurity/trivy-release-test/commit/48dfedeb1e13d1654e2b9239f403d847af353e2e))
* **misconf:** Update Azure network schema for new checks ([#9791](https://github.com/aquasecurity/trivy-release-test/issues/9791)) ([ea2dc58](https://github.com/aquasecurity/trivy-release-test/commit/ea2dc586b83fec6eac1b5de04fd9e5a06db4e16a))
* **misconf:** Update azure storage schema ([#9728](https://github.com/aquasecurity/trivy-release-test/issues/9728)) ([c3bfecf](https://github.com/aquasecurity/trivy-release-test/commit/c3bfecf3ef236f333ebf1ace7fa2f739fdcbdcca))
* **misconf:** Update SecurityCenter schema ([#9674](https://github.com/aquasecurity/trivy-release-test/issues/9674)) ([58819c5](https://github.com/aquasecurity/trivy-release-test/commit/58819c5285520b55bc6a5ed30aab82826aee3065))
* **misconf:** use Terraform plan configuration to partially restore schema ([#9623](https://github.com/aquasecurity/trivy-release-test/issues/9623)) ([5fced3a](https://github.com/aquasecurity/trivy-release-test/commit/5fced3ae492281f0fe000e5ccf3c634425c008d8))
* **nodejs:** add a bun.lock analyzer ([#8897](https://github.com/aquasecurity/trivy-release-test/issues/8897)) ([7ca656d](https://github.com/aquasecurity/trivy-release-test/commit/7ca656d54b99346253fc6ac6422eecaca169514e))
* **nodejs:** add bun.lock parser ([#8851](https://github.com/aquasecurity/trivy-release-test/issues/8851)) ([1dcf816](https://github.com/aquasecurity/trivy-release-test/commit/1dcf81666f1c814600702b9ab603b4070da0b940))
* **nodejs:** parse licenses from `package-lock.json` file ([#9983](https://github.com/aquasecurity/trivy-release-test/issues/9983)) ([b64d5ad](https://github.com/aquasecurity/trivy-release-test/commit/b64d5adc6b90fde205e4eeaf7b58332bf10372d2))
* **php:** add support for dev dependencies in Composer ([#9910](https://github.com/aquasecurity/trivy-release-test/issues/9910)) ([56b59e8](https://github.com/aquasecurity/trivy-release-test/commit/56b59e8abbb891564bf03608b8150bceaeb60ded))
* **python:** add pylock.toml (PEP 751) parser ([#9632](https://github.com/aquasecurity/trivy-release-test/issues/9632)) ([1a72b32](https://github.com/aquasecurity/trivy-release-test/commit/1a72b326bba9e0959d5f3b63367bb311f064d795))
* **python:** add pylock.toml support ([#10137](https://github.com/aquasecurity/trivy-release-test/issues/10137)) ([d0a3f63](https://github.com/aquasecurity/trivy-release-test/commit/d0a3f63b84e6a8cd9067e85344097f9179c14b0d))
* **redhat:** Add EOL date for RHEL 10. ([#8910](https://github.com/aquasecurity/trivy-release-test/issues/8910)) ([48258a7](https://github.com/aquasecurity/trivy-release-test/commit/48258a701a7adb210c433310de52f48568ccee19))
* **redhat:** add os-release detection for RHEL-based images ([#9458](https://github.com/aquasecurity/trivy-release-test/issues/9458)) ([cb25a07](https://github.com/aquasecurity/trivy-release-test/commit/cb25a074501c5cf48050fdf6a0ae7c85c4f385ea))
* reject unsupported artifact types in remote image retrieval ([#9052](https://github.com/aquasecurity/trivy-release-test/issues/9052)) ([1e1e1b5](https://github.com/aquasecurity/trivy-release-test/commit/1e1e1b5fa6a884da978fe1ed4c222d613d6eafbd))
* **repo:** add git repository metadata to reports ([#9252](https://github.com/aquasecurity/trivy-release-test/issues/9252)) ([f4b2cf1](https://github.com/aquasecurity/trivy-release-test/commit/f4b2cf10e917d58c0840f789e083bd3f268a8af1))
* **report:** add CVSS vectors in sarif report ([#9157](https://github.com/aquasecurity/trivy-release-test/issues/9157)) ([60723e6](https://github.com/aquasecurity/trivy-release-test/commit/60723e6cfce82ede2863cf545a189c581246f4e9))
* **report:** add fingerprint generation for vulnerabilities ([#9794](https://github.com/aquasecurity/trivy-release-test/issues/9794)) ([cbad9ca](https://github.com/aquasecurity/trivy-release-test/commit/cbad9ca3a888cb3fb6b8649e683efe4f7047a8ed))
* **report:** add image reference to report metadata ([#9729](https://github.com/aquasecurity/trivy-release-test/issues/9729)) ([d020f26](https://github.com/aquasecurity/trivy-release-test/commit/d020f2690e58c328f96e3083ce57fe2b71f308f3))
* **report:** add Trivy version to JSON output ([#10065](https://github.com/aquasecurity/trivy-release-test/issues/10065)) ([fe7d20a](https://github.com/aquasecurity/trivy-release-test/commit/fe7d20a31c02b7ce61d85d264883831208132002))
* **report:** switch ReportID from UUIDv4 to UUIDv7 ([#9749](https://github.com/aquasecurity/trivy-release-test/issues/9749)) ([6fb3fde](https://github.com/aquasecurity/trivy-release-test/commit/6fb3fde916f991ccca8f23e18ab4d46e0780e50d))
* **rocky:** enable modular package vulnerability detection ([#10069](https://github.com/aquasecurity/trivy-release-test/issues/10069)) ([31c4780](https://github.com/aquasecurity/trivy-release-test/commit/31c4780f720c5adeb6488440406dc7fad7637dae))
* **rootio:** Update trivy db to support usage of Severity from root.io feed ([#9930](https://github.com/aquasecurity/trivy-release-test/issues/9930)) ([d3096e7](https://github.com/aquasecurity/trivy-release-test/commit/d3096e7617a6b5d6bc5beb2abce1b18a70c05c08))
* **sbom:** add manufacturer field to CycloneDX tools metadata ([#9019](https://github.com/aquasecurity/trivy-release-test/issues/9019)) ([41d0f94](https://github.com/aquasecurity/trivy-release-test/commit/41d0f949c874609641c08fa2620fa10bf4ceef78))
* **sbom:** add SHA-512 hash support for CycloneDX SBOM ([#9126](https://github.com/aquasecurity/trivy-release-test/issues/9126)) ([12d6706](https://github.com/aquasecurity/trivy-release-test/commit/12d6706961423acb12430c8b3d986b4aa4671d04))
* **sbom:** add support for SPDX attestations ([#9829](https://github.com/aquasecurity/trivy-release-test/issues/9829)) ([d8eaaeb](https://github.com/aquasecurity/trivy-release-test/commit/d8eaaeb611151f1da3583ec50100a7be09ce9bc5))
* **sbom:** added support for CoreOS ([#9448](https://github.com/aquasecurity/trivy-release-test/issues/9448)) ([6d562a3](https://github.com/aquasecurity/trivy-release-test/commit/6d562a3b48926b6efd508e067e1059564173b270))
* **sbom:** exclude PEP 770 SBOMs in .dist-info/sboms/ ([#10033](https://github.com/aquasecurity/trivy-release-test/issues/10033)) ([07ff788](https://github.com/aquasecurity/trivy-release-test/commit/07ff7885df5397531271b837d4d9402a7d58e8a3))
* **sbom:** use SPDX license IDs list to validate SPDX IDs  ([#9569](https://github.com/aquasecurity/trivy-release-test/issues/9569)) ([35db88c](https://github.com/aquasecurity/trivy-release-test/commit/35db88c81cc5cdb8ab25362aea455c586d2e1d32))
* **seal:** add seal support ([#9370](https://github.com/aquasecurity/trivy-release-test/issues/9370)) ([e4af279](https://github.com/aquasecurity/trivy-release-test/commit/e4af279b29ed5b77ed1d62e31b232b1f9b92ef4f))
* **secret:** add detection for Symfony default secret key ([#9892](https://github.com/aquasecurity/trivy-release-test/issues/9892)) ([34baef2](https://github.com/aquasecurity/trivy-release-test/commit/34baef28ecb31c7a9ba414a118b220da97b29634))
* **secret:** implement streaming secret scanner with byte offset tracking ([#9264](https://github.com/aquasecurity/trivy-release-test/issues/9264)) ([5a5e097](https://github.com/aquasecurity/trivy-release-test/commit/5a5e0972c72e629ddf2915ef066d632d58b8d3b0))
* **server:** include server version info in JSON output for client/server mode ([#10075](https://github.com/aquasecurity/trivy-release-test/issues/10075)) ([4c46d41](https://github.com/aquasecurity/trivy-release-test/commit/4c46d418c58c9a070a87b9d3c88966d40e435329))
* **suse:** Add new openSUSE, Micro and SLES releases end of life dates ([#9788](https://github.com/aquasecurity/trivy-release-test/issues/9788)) ([019af7f](https://github.com/aquasecurity/trivy-release-test/commit/019af7fefdc1da55610446ca07f13b2ea84348b5))
* terraform parser option to set current working directory ([#8909](https://github.com/aquasecurity/trivy-release-test/issues/8909)) ([8939451](https://github.com/aquasecurity/trivy-release-test/commit/893945117464bf6e090a55e3822f8299825f26d4))
* **terraform:** add partial evaluation for policy templates ([#8967](https://github.com/aquasecurity/trivy-release-test/issues/8967)) ([a9f7dcd](https://github.com/aquasecurity/trivy-release-test/commit/a9f7dcdb9c5973746c3737f2bbc3306a74be5408))
* **terraform:** use .terraform cache for remote modules in plan scanning ([#9277](https://github.com/aquasecurity/trivy-release-test/issues/9277)) ([298a994](https://github.com/aquasecurity/trivy-release-test/commit/298a9941f098d2701b9524a703b9f9b1b9451785))
* **ubuntu:** add end of life date for Ubuntu 25.04 ([#9077](https://github.com/aquasecurity/trivy-release-test/issues/9077)) ([367564a](https://github.com/aquasecurity/trivy-release-test/commit/367564a3bec0c202566c59598dcff087bf50a23d))
* **ubuntu:** add eol data for 25.10 ([#10181](https://github.com/aquasecurity/trivy-release-test/issues/10181)) ([2c1f65b](https://github.com/aquasecurity/trivy-release-test/commit/2c1f65bdeec62baef45e93f58cc8e5eca7d84d26))
* **ubuntu:** add eol date for 20.04-ESM ([#8981](https://github.com/aquasecurity/trivy-release-test/issues/8981)) ([87118a0](https://github.com/aquasecurity/trivy-release-test/commit/87118a0ec4a6ae492523b7bac9834c2b93a14557))
* **vex:** support per-repo tls configuration ([#10030](https://github.com/aquasecurity/trivy-release-test/issues/10030)) ([f809066](https://github.com/aquasecurity/trivy-release-test/commit/f809066b0745769876be8006e00dcf44017ffe96))
* **vuln:** add Root.io support for container image scanning ([#9073](https://github.com/aquasecurity/trivy-release-test/issues/9073)) ([3a0ec0f](https://github.com/aquasecurity/trivy-release-test/commit/3a0ec0f2acff6a13ed6ab348b6b220d49e14a298))
* **vuln:** skip third-party packages in common Detect function ([#10129](https://github.com/aquasecurity/trivy-release-test/issues/10129)) ([d6e6331](https://github.com/aquasecurity/trivy-release-test/commit/d6e6331abba28fe22f6d8d3bc36f7821601ff8ad))
* **vuln:** skip vulnerability scanning for third-party packages in Debian/Ubuntu ([#9932](https://github.com/aquasecurity/trivy-release-test/issues/9932)) ([74819bf](https://github.com/aquasecurity/trivy-release-test/commit/74819bf45733eda0a8377c40d09a60daefe9210a))


### Bug Fixes

* add `buildInfo` for `BlobInfo` in `rpc` package ([#9608](https://github.com/aquasecurity/trivy-release-test/issues/9608)) ([6def66e](https://github.com/aquasecurity/trivy-release-test/commit/6def66e002427eadcc6dbabe56b01c37c1eae075))
* Add missing version check flags ([#8951](https://github.com/aquasecurity/trivy-release-test/issues/8951)) ([ef5f8de](https://github.com/aquasecurity/trivy-release-test/commit/ef5f8de8dadf5534a2c965aecca01c7067e5baca))
* **alma:** parse epochs from rpmqa file ([#9101](https://github.com/aquasecurity/trivy-release-test/issues/9101)) ([82db2fc](https://github.com/aquasecurity/trivy-release-test/commit/82db2fcc8034c911cc7a67f5a82d2f081d9c1fdf))
* also check `filepath` when removing duplicate packages ([#9142](https://github.com/aquasecurity/trivy-release-test/issues/9142)) ([4d10a81](https://github.com/aquasecurity/trivy-release-test/commit/4d10a815dde53f5e128366f1dd0837a1dc29c17b))
* **aws:** update amazon linux 2 EOL date ([#9176](https://github.com/aquasecurity/trivy-release-test/issues/9176)) ([0ecfed6](https://github.com/aquasecurity/trivy-release-test/commit/0ecfed6ea75cfe33e0f436a9015ac72a679e754e))
* **aws:** use `BuildableClient` insead of `xhttp.Client` ([#9436](https://github.com/aquasecurity/trivy-release-test/issues/9436)) ([fa6f1bf](https://github.com/aquasecurity/trivy-release-test/commit/fa6f1bfecfb68c29ad4684a6fb5d86948c7d6887))
* check post-analyzers for StaticPaths ([#8904](https://github.com/aquasecurity/trivy-release-test/issues/8904)) ([93e6680](https://github.com/aquasecurity/trivy-release-test/commit/93e6680b1c6bbb590157f521c667c0f611775143))
* **cli:** Add more non-sensitive flags to telemetry ([#9110](https://github.com/aquasecurity/trivy-release-test/issues/9110)) ([7041a39](https://github.com/aquasecurity/trivy-release-test/commit/7041a39bdcf21c5b3114137d9a931f529eac2566))
* **cli:** add some values to the telemetry call ([#9056](https://github.com/aquasecurity/trivy-release-test/issues/9056)) ([fd2bc91](https://github.com/aquasecurity/trivy-release-test/commit/fd2bc91e133f846bc9f0910c19ac3be3fbfe4009))
* **cli:** disable `--skip-dir` and `--skip-files` flags for `sbom` command ([#8886](https://github.com/aquasecurity/trivy-release-test/issues/8886)) ([69a5fa1](https://github.com/aquasecurity/trivy-release-test/commit/69a5fa18ca86ff7e5206abacf98732d46c000c7a))
* **cli:** don't use allow values for `--compliance` flag ([#8881](https://github.com/aquasecurity/trivy-release-test/issues/8881)) ([35e8889](https://github.com/aquasecurity/trivy-release-test/commit/35e88890c3c201b3eb11f95376172e57bf44df4b))
* **cli:** ensure correct command is picked by telemetry ([#9260](https://github.com/aquasecurity/trivy-release-test/issues/9260)) ([b4ad00f](https://github.com/aquasecurity/trivy-release-test/commit/b4ad00f301a5fd7326060a567871c6f4a9711696))
* **cli:** panic: attempt to get os.Args[1] when len(os.Args) &lt; 2 ([#9206](https://github.com/aquasecurity/trivy-release-test/issues/9206)) ([adfa879](https://github.com/aquasecurity/trivy-release-test/commit/adfa879e4e8ab88f211222a13d2b89013ae9a853))
* close all opened resources if an error occurs ([#9665](https://github.com/aquasecurity/trivy-release-test/issues/9665)) ([fa6f779](https://github.com/aquasecurity/trivy-release-test/commit/fa6f77902234f5bee70287a841e8cfa42ca4a505))
* close file descriptors and pipes on error paths ([#9536](https://github.com/aquasecurity/trivy-release-test/issues/9536)) ([a4cbd6a](https://github.com/aquasecurity/trivy-release-test/commit/a4cbd6a1380b7b4dc650a312ec4e5bc47501f674))
* **conda:** memory leak by adding closure method for `package.json` file ([#9349](https://github.com/aquasecurity/trivy-release-test/issues/9349)) ([03d039f](https://github.com/aquasecurity/trivy-release-test/commit/03d039f17d94cf668152e83d0cf9dabf3b27d3dd))
* Correctly check for semver versions for trivy version check ([#8948](https://github.com/aquasecurity/trivy-release-test/issues/8948)) ([b813527](https://github.com/aquasecurity/trivy-release-test/commit/b813527449c4604f5afad71ae82b13399bb48680))
* create temp file under composite fs dir ([#9387](https://github.com/aquasecurity/trivy-release-test/issues/9387)) ([ce22f54](https://github.com/aquasecurity/trivy-release-test/commit/ce22f54a39a1abac08fa3ad540697c668792bf50))
* **cyclonedx:** handle multiple license types ([#9378](https://github.com/aquasecurity/trivy-release-test/issues/9378)) ([46ab76a](https://github.com/aquasecurity/trivy-release-test/commit/46ab76a5af828c98cf93fc988ed6a405b7b07392))
* **cyclonedx:** include CVSS v4 vulnerability ratings ([#10313](https://github.com/aquasecurity/trivy-release-test/issues/10313)) ([2a4dfbf](https://github.com/aquasecurity/trivy-release-test/commit/2a4dfbf18a71a17de2c22c02afc5742466f6d799))
* **db:** Dowload database when missing but metadata still exists ([#9393](https://github.com/aquasecurity/trivy-release-test/issues/9393)) ([92ebc7e](https://github.com/aquasecurity/trivy-release-test/commit/92ebc7e4d72424c17d93c54e5f24891710c85a60))
* detected vulnerability fields in azure and mariner detector ([#10275](https://github.com/aquasecurity/trivy-release-test/issues/10275)) ([77f5cb5](https://github.com/aquasecurity/trivy-release-test/commit/77f5cb5abda49844b936322e85829b256cb4599c))
* **docker:** fix non-det scan results for images with embedded SBOM ([#9866](https://github.com/aquasecurity/trivy-release-test/issues/9866)) ([7f71b57](https://github.com/aquasecurity/trivy-release-test/commit/7f71b577a0e138fc2908f9a8c2932b11004041db))
* don't show corrupted trivy-db warning for first run ([#8991](https://github.com/aquasecurity/trivy-release-test/issues/8991)) ([4ed78e3](https://github.com/aquasecurity/trivy-release-test/commit/4ed78e39afe57e81c12482fef9102dc3f85d1493))
* **flag:** remove viper.SetDefault to fix IsSet() for config-only flags ([#9732](https://github.com/aquasecurity/trivy-release-test/issues/9732)) ([bf43629](https://github.com/aquasecurity/trivy-release-test/commit/bf43629d320426b18e7177b4b6f05affb6f93374))
* **flag:** validate template file extension ([#10296](https://github.com/aquasecurity/trivy-release-test/issues/10296)) ([20458b8](https://github.com/aquasecurity/trivy-release-test/commit/20458b836b71b2bed72d31ebba1ba9572333dcfd))
* **fs:** avoid shadowing errors in file.glob ([#9286](https://github.com/aquasecurity/trivy-release-test/issues/9286)) ([b51c789](https://github.com/aquasecurity/trivy-release-test/commit/b51c789330141d634a9b14bd10994c997862940f))
* **go:** use ldflags version for all pseudo-versions    ([#10037](https://github.com/aquasecurity/trivy-release-test/issues/10037)) ([3c0ab97](https://github.com/aquasecurity/trivy-release-test/commit/3c0ab97e10dc451a7fb91ef6283a932c9c4db6bf))
* handle Go 1.26 GOEXPERIMENT version format change ([#10351](https://github.com/aquasecurity/trivy-release-test/issues/10351)) ([f207ec6](https://github.com/aquasecurity/trivy-release-test/commit/f207ec693b23b6d5114dbf3b309903689b93073d))
* **image:** race condition in image artifact inspection ([#9966](https://github.com/aquasecurity/trivy-release-test/issues/9966)) ([18acf4f](https://github.com/aquasecurity/trivy-release-test/commit/18acf4f71dfa0668b0fe8b0ffcafd960f88b46d1))
* **image:** use standardized HTTP client for ECR authentication ([#9322](https://github.com/aquasecurity/trivy-release-test/issues/9322)) ([84fbf86](https://github.com/aquasecurity/trivy-release-test/commit/84fbf8674dfc0f91d8795a50bafa6041cce83ba2))
* **java:** add hash of GAV+root pom file path for pkgID for packages from pom.xml files ([#9880](https://github.com/aquasecurity/trivy-release-test/issues/9880)) ([809db46](https://github.com/aquasecurity/trivy-release-test/commit/809db462317fb43317e2d4f7116a8e96c1b2a728))
* **java:** correctly inherit properties from parent fields for pom.xml files ([#9111](https://github.com/aquasecurity/trivy-release-test/issues/9111)) ([2933b01](https://github.com/aquasecurity/trivy-release-test/commit/2933b01cd55bc73ab99e6e867532093f2d65c94f))
* **java:** correctly propagate repositories from upper POMs to dependencies ([#10077](https://github.com/aquasecurity/trivy-release-test/issues/10077)) ([b9415a3](https://github.com/aquasecurity/trivy-release-test/commit/b9415a309cf6bd34505afcda05dc0b0ad8b78059))
* **java:** Disable overwriting exclusions ([#10088](https://github.com/aquasecurity/trivy-release-test/issues/10088)) ([9a3e0a8](https://github.com/aquasecurity/trivy-release-test/commit/9a3e0a845db68a79f4fd0e71f5cb7d8ca3976bbe))
* **java:** update order for resolving package fields from multiple demManagement ([#9575](https://github.com/aquasecurity/trivy-release-test/issues/9575)) ([e286c5e](https://github.com/aquasecurity/trivy-release-test/commit/e286c5e207b6d8a1ef01f3f634f874e2e3d4c0f0))
* **java:** use `true` as default value for Repository Release|Snapshot Enabled in pom.xml and settings.xml files ([#9751](https://github.com/aquasecurity/trivy-release-test/issues/9751)) ([d87d9b9](https://github.com/aquasecurity/trivy-release-test/commit/d87d9b97d1a61d05a9b1742caaa7e0125c481e2c))
* julia parser panicing ([#8883](https://github.com/aquasecurity/trivy-release-test/issues/8883)) ([be8c7b7](https://github.com/aquasecurity/trivy-release-test/commit/be8c7b796dbe36d8dc3889e0bdea23336de9a1ab))
* **julia:** add `Relationship` field support ([#8939](https://github.com/aquasecurity/trivy-release-test/issues/8939)) ([22f040f](https://github.com/aquasecurity/trivy-release-test/commit/22f040f94790060132c7b0a635f44c35d5a35fb6))
* **k8s:** disable parallel traversal with fs cache for k8s images ([#9534](https://github.com/aquasecurity/trivy-release-test/issues/9534)) ([c0c7a6b](https://github.com/aquasecurity/trivy-release-test/commit/c0c7a6bf1b92c868ed44172b3cd15c51667b8a6e))
* **k8s:** use in-memory cache backend during misconfig scanning ([#8873](https://github.com/aquasecurity/trivy-release-test/issues/8873)) ([fe12771](https://github.com/aquasecurity/trivy-release-test/commit/fe127715e505d753e0d878d52c5f280cdc326b76))
* **license:** add missed `GFDL-NIV-1.1` and `GFDL-NIV-1.2` into Trivy mapping ([#9116](https://github.com/aquasecurity/trivy-release-test/issues/9116)) ([a692f29](https://github.com/aquasecurity/trivy-release-test/commit/a692f296d15f7241ba5ff082e4e69926b1c728a8))
* **license:** don't normalize `unlicensed` licenses into `unlicense` ([#9611](https://github.com/aquasecurity/trivy-release-test/issues/9611)) ([09162e5](https://github.com/aquasecurity/trivy-release-test/commit/09162e52ecf2a3e7a65dcf4ab2c2ea43ee6f5437))
* **license:** handle SPDX WITH exceptions as single license in category detection ([#9380](https://github.com/aquasecurity/trivy-release-test/issues/9380)) ([212f078](https://github.com/aquasecurity/trivy-release-test/commit/212f0781c552cd0395791a4a0276e1e39579f491))
* **license:** handle WITH operator for `LaxSplitLicenses` ([#9232](https://github.com/aquasecurity/trivy-release-test/issues/9232)) ([b4193d0](https://github.com/aquasecurity/trivy-release-test/commit/b4193d0d31a167aafdcd9d9ccd89f3f124eef7ee))
* **license:** normalize licenses for PostAnalyzers ([#9941](https://github.com/aquasecurity/trivy-release-test/issues/9941)) ([11dd3fa](https://github.com/aquasecurity/trivy-release-test/commit/11dd3fac3825b45e5d4c5dd473f18c0c76e18bf5))
* migrate from `*.list` to `*.md5sums` files for `dpkg` ([#9131](https://github.com/aquasecurity/trivy-release-test/issues/9131)) ([f224de3](https://github.com/aquasecurity/trivy-release-test/commit/f224de3e39b08672212ec0f94660c36bef77bc30))
* **misconf:** .Config.User always takes precedence over USER in .History ([#9050](https://github.com/aquasecurity/trivy-release-test/issues/9050)) ([371b8cc](https://github.com/aquasecurity/trivy-release-test/commit/371b8cc02f2ffa3f42534a437ce8727519e7b9b9))
* **misconf:** apply check aliases when filtering results via .trivyignore ([#10112](https://github.com/aquasecurity/trivy-release-test/issues/10112)) ([b775a1b](https://github.com/aquasecurity/trivy-release-test/commit/b775a1b63cd7afeda8dec2c1c8b8b6d422418bc6))
* **misconf:** correct Azure value-to-time conversion in AsTimeValue ([#9015](https://github.com/aquasecurity/trivy-release-test/issues/9015)) ([40d017b](https://github.com/aquasecurity/trivy-release-test/commit/40d017b67da38131734eab90c42ad945ac3b5013))
* **misconf:** correct typos in block and attribute names ([#9993](https://github.com/aquasecurity/trivy-release-test/issues/9993)) ([ac061f8](https://github.com/aquasecurity/trivy-release-test/commit/ac061f8e887ab5a415b8c13474493c0541a48317))
* **misconf:** correctly adapt azure storage account ([#9138](https://github.com/aquasecurity/trivy-release-test/issues/9138)) ([51aa022](https://github.com/aquasecurity/trivy-release-test/commit/51aa0222604829706193eb2ff3a6886742bb42b4))
* **misconf:** correctly parse empty port ranges in google_compute_firewall ([#9237](https://github.com/aquasecurity/trivy-release-test/issues/9237)) ([77bab7b](https://github.com/aquasecurity/trivy-release-test/commit/77bab7b6d25c712e2db7dc53956985c2721728e9))
* **misconf:** ensure boolean metadata values are correctly interpreted ([#9770](https://github.com/aquasecurity/trivy-release-test/issues/9770)) ([a6ceff7](https://github.com/aquasecurity/trivy-release-test/commit/a6ceff7e83121e2c9e618dcb0584aa62e7077bbf))
* **misconf:** ensure ignore rules respect subdirectory chart paths ([#9324](https://github.com/aquasecurity/trivy-release-test/issues/9324)) ([d3cd101](https://github.com/aquasecurity/trivy-release-test/commit/d3cd101266eb7bf9b8ffe5899765efa7bd1abe30))
* **misconf:** ensure module source is known ([#9404](https://github.com/aquasecurity/trivy-release-test/issues/9404)) ([81d9425](https://github.com/aquasecurity/trivy-release-test/commit/81d94253c8bc816ad932f7e0c0b8907e1cd759bb))
* **misconf:** ensure value used as ignore marker is non-null and known ([#9835](https://github.com/aquasecurity/trivy-release-test/issues/9835)) ([7aca801](https://github.com/aquasecurity/trivy-release-test/commit/7aca80151c2073999aa43213ae03a86b3d13a54c))
* **misconf:** fix log bucket in schema ([#9235](https://github.com/aquasecurity/trivy-release-test/issues/9235)) ([7ebc129](https://github.com/aquasecurity/trivy-release-test/commit/7ebc129ab726f3133d940708837b7edda2621105))
* **misconf:** handle tofu files in module detection ([#9486](https://github.com/aquasecurity/trivy-release-test/issues/9486)) ([bfd2f6b](https://github.com/aquasecurity/trivy-release-test/commit/bfd2f6ba697c223d60a7378283293d8e1fc8a8fe))
* **misconf:** handle unsupported experimental flags in Dockerfile ([#9769](https://github.com/aquasecurity/trivy-release-test/issues/9769)) ([08d51a8](https://github.com/aquasecurity/trivy-release-test/commit/08d51a8e08c1c7f159ca491810d0d08dc787f93e))
* **misconf:** initialize custom annotation field if empty ([#10123](https://github.com/aquasecurity/trivy-release-test/issues/10123)) ([0f0d6db](https://github.com/aquasecurity/trivy-release-test/commit/0f0d6dbff4825f7b0ea7744b2229e0157af52972))
* **misconf:** map healthcheck start period flag to --start-period instead of --startPeriod ([#9837](https://github.com/aquasecurity/trivy-release-test/issues/9837)) ([7b2b4d4](https://github.com/aquasecurity/trivy-release-test/commit/7b2b4d4b459358ed0f561aa30639282211c80cc1))
* **misconf:** move disabled checks filtering after analyzer scan ([#9002](https://github.com/aquasecurity/trivy-release-test/issues/9002)) ([a58c36d](https://github.com/aquasecurity/trivy-release-test/commit/a58c36de124cba7250e1a5ae0cc32d83018391fe))
* **misconf:** preserve original paths of remote submodules from .terraform ([#9294](https://github.com/aquasecurity/trivy-release-test/issues/9294)) ([1319d8d](https://github.com/aquasecurity/trivy-release-test/commit/1319d8dc7f4796177876af18f0e13ba1f7086348))
* **misconf:** reduce log noise on incompatible check ([#9029](https://github.com/aquasecurity/trivy-release-test/issues/9029)) ([99c5151](https://github.com/aquasecurity/trivy-release-test/commit/99c5151d6ea1dabe85cce75ff9bb91166532b11f))
* **misconf:** respect .yml files when Helm charts are detected ([#9912](https://github.com/aquasecurity/trivy-release-test/issues/9912)) ([18ecf75](https://github.com/aquasecurity/trivy-release-test/commit/18ecf75176a1cadcf20e088a991af899e96fe40b))
* **misconf:** safely parse rotation_period in google_kms_crypto_key ([#9980](https://github.com/aquasecurity/trivy-release-test/issues/9980)) ([a0ecc8e](https://github.com/aquasecurity/trivy-release-test/commit/a0ecc8e9267cb63ee3d2cd28c82561e39533031d))
* **misconf:** skip rewriting expr if attr is nil ([#9113](https://github.com/aquasecurity/trivy-release-test/issues/9113)) ([42ccd3d](https://github.com/aquasecurity/trivy-release-test/commit/42ccd3df9a7c838a99facb8248e1a68eaf47a999))
* **misconf:** strip build metadata suffixes from image history ([#9498](https://github.com/aquasecurity/trivy-release-test/issues/9498)) ([c938806](https://github.com/aquasecurity/trivy-release-test/commit/c9388069a4325a9f8bc53bc8a82ff46d84d06847))
* **misconf:** unmark cty values before access ([#9495](https://github.com/aquasecurity/trivy-release-test/issues/9495)) ([8e40d27](https://github.com/aquasecurity/trivy-release-test/commit/8e40d27a43ecb96795a8a7d4a2444241fc7fce9a))
* **misconf:** use argument value in WithIncludeDeprecatedChecks ([#8942](https://github.com/aquasecurity/trivy-release-test/issues/8942)) ([7e9a54c](https://github.com/aquasecurity/trivy-release-test/commit/7e9a54cd6bf4bc15e485c6233d140b389e432fe5))
* **misconf:** use correct field log_bucket instead of target_bucket in gcp bucket ([#9296](https://github.com/aquasecurity/trivy-release-test/issues/9296)) ([04ad0c4](https://github.com/aquasecurity/trivy-release-test/commit/04ad0c4fc2926a92e9e9ec11bb8eae826ed95827))
* **misconf:** wrap legacy ENV values in quotes to preserve spaces ([#9497](https://github.com/aquasecurity/trivy-release-test/issues/9497)) ([267a970](https://github.com/aquasecurity/trivy-release-test/commit/267a9700fa233abe1a04eada8f3ea513f3ebacb3))
* move enum into items for array-type fields in JSON Schema ([#10039](https://github.com/aquasecurity/trivy-release-test/issues/10039)) ([4e06c3d](https://github.com/aquasecurity/trivy-release-test/commit/4e06c3df5b77f92e5390dc7d3559036f1fdf6cad))
* **nodejs:** correctly parse `packages` array of `bun.lock` file ([#8998](https://github.com/aquasecurity/trivy-release-test/issues/8998)) ([875ec3a](https://github.com/aquasecurity/trivy-release-test/commit/875ec3a9d2568e15a6824c8f84ad6a59f03eb212))
* **nodejs:** don't use prerelease logic for compare npm constraints  ([#9208](https://github.com/aquasecurity/trivy-release-test/issues/9208)) ([fe96436](https://github.com/aquasecurity/trivy-release-test/commit/fe96436b99bae3bbfc7498d2ad222d4acccdfcf1))
* **nodejs:** fix npmjs parser.pkgNameFromPath() panic issue ([#9688](https://github.com/aquasecurity/trivy-release-test/issues/9688)) ([231492d](https://github.com/aquasecurity/trivy-release-test/commit/231492db52ce69c8d9186b039b038bf0153f8dfa))
* **nodejs:** parse workspaces as objects for package-lock.json files ([#9518](https://github.com/aquasecurity/trivy-release-test/issues/9518)) ([404abb3](https://github.com/aquasecurity/trivy-release-test/commit/404abb3d91cb3b1c1ee027169de5a40e32ba8b8a))
* **nodejs:** use snapshot string as `Package.ID` for pnpm packages ([#9330](https://github.com/aquasecurity/trivy-release-test/issues/9330)) ([4517e8c](https://github.com/aquasecurity/trivy-release-test/commit/4517e8c0ef5e942b8e2e498729257374634ffbf8))
* **nodejs:** use the default ID format to match licenses in pnpm packages. ([#9661](https://github.com/aquasecurity/trivy-release-test/issues/9661)) ([804ea4a](https://github.com/aquasecurity/trivy-release-test/commit/804ea4aa575e486fd888f59c9ceb495857b57f8c))
* **os:** Add photon 5.0 in supported OS ([#9724](https://github.com/aquasecurity/trivy-release-test/issues/9724)) ([29f0347](https://github.com/aquasecurity/trivy-release-test/commit/29f034796590bc6b7a17fa4fee8b43c822a77c13))
* persistent flag option typo ([#9374](https://github.com/aquasecurity/trivy-release-test/issues/9374)) ([6e99dd3](https://github.com/aquasecurity/trivy-release-test/commit/6e99dd304c7fad8213489039e7ca42909383b5ff))
* **plugin:** don't remove plugins when updating index.yaml file ([#9358](https://github.com/aquasecurity/trivy-release-test/issues/9358)) ([5f067ac](https://github.com/aquasecurity/trivy-release-test/commit/5f067ac15e5c609283bef26a211746a279b6b5d0))
* prevent graceful shutdown message on normal exit ([#9244](https://github.com/aquasecurity/trivy-release-test/issues/9244)) ([6095984](https://github.com/aquasecurity/trivy-release-test/commit/6095984d5340633740204a7a40f002a5643802b9))
* **python:** handle multiple version specifiers in requirements.txt ([#10361](https://github.com/aquasecurity/trivy-release-test/issues/10361)) ([4cf4498](https://github.com/aquasecurity/trivy-release-test/commit/4cf44985c58575850138c9cc3780b201dfad7c09))
* **python:** impove package name normalization  ([#9290](https://github.com/aquasecurity/trivy-release-test/issues/9290)) ([1473e88](https://github.com/aquasecurity/trivy-release-test/commit/1473e88b74ca269691de7827e045703612b90050))
* **python:** nil pointer dereference with optional poetry groups without dependencies ([#10359](https://github.com/aquasecurity/trivy-release-test/issues/10359)) ([12ab3ce](https://github.com/aquasecurity/trivy-release-test/commit/12ab3cee257f89b3b180c38bc2d765dc4c7918a1))
* **redhat:** Also try to find buildinfo in root layer (layer 0) ([#8924](https://github.com/aquasecurity/trivy-release-test/issues/8924)) ([906b037](https://github.com/aquasecurity/trivy-release-test/commit/906b037cff97060267d20f8947f429e078419d66))
* remove os.Stdout from wazero module config ([#10403](https://github.com/aquasecurity/trivy-release-test/issues/10403)) ([bda9710](https://github.com/aquasecurity/trivy-release-test/commit/bda9710eb0c4c7d5ba1bc60bbaa06d43dc3c523a))
* remove trailing tab in statefulset template ([#9889](https://github.com/aquasecurity/trivy-release-test/issues/9889)) ([9db123c](https://github.com/aquasecurity/trivy-release-test/commit/9db123ccf80e55b30bee53db7163b9fd9a38bd75))
* **repo:** preserve RepoMetadata on FS cache hit ([#9389](https://github.com/aquasecurity/trivy-release-test/issues/9389)) ([4f2a44e](https://github.com/aquasecurity/trivy-release-test/commit/4f2a44ea45bed1e842bb2072077da67ec7e744ac))
* **repo:** return a nil interface for gitAuth if missing ([#10097](https://github.com/aquasecurity/trivy-release-test/issues/10097)) ([036c05b](https://github.com/aquasecurity/trivy-release-test/commit/036c05b9a12eaccd7ebe8ee2f69d610fb7eea1fc))
* **report:** correct field order in SARIF license results ([#9712](https://github.com/aquasecurity/trivy-release-test/issues/9712)) ([d20216e](https://github.com/aquasecurity/trivy-release-test/commit/d20216edf6fdbd0281173b25b796880bc6b2b210))
* **report:** don't panic when report contains vulns, but doesn't contain packages for `table` format ([#8549](https://github.com/aquasecurity/trivy-release-test/issues/8549)) ([87fda76](https://github.com/aquasecurity/trivy-release-test/commit/87fda76f38a3a6939a87828c3df0c5ac2cf7fce3))
* **report:** set correct sarif ROOTPATH uri when scanning a git repository ([#10366](https://github.com/aquasecurity/trivy-release-test/issues/10366)) ([e5da6de](https://github.com/aquasecurity/trivy-release-test/commit/e5da6deee9904d00cb4fd5ea1f67e8a1711ec8dd))
* **repo:** sanitize git repo URL before inserting into report metadata ([#9391](https://github.com/aquasecurity/trivy-release-test/issues/9391)) ([1ac9b1f](https://github.com/aquasecurity/trivy-release-test/commit/1ac9b1f07cea429cc122bf9721e8909c649549cf))
* restore compatibility for google.protobuf.Value ([#9559](https://github.com/aquasecurity/trivy-release-test/issues/9559)) ([aeeb2a1](https://github.com/aquasecurity/trivy-release-test/commit/aeeb2a1f842b56147996b600bd34db2cf05cd28e))
* **rootio:** check full version to detect `root.io` packages ([#9117](https://github.com/aquasecurity/trivy-release-test/issues/9117)) ([c2ddd44](https://github.com/aquasecurity/trivy-release-test/commit/c2ddd44d98594a2066cb5b5acbb9ad2aaad8fd96))
* **rootio:** fix severity selection ([#9181](https://github.com/aquasecurity/trivy-release-test/issues/9181)) ([6fafbeb](https://github.com/aquasecurity/trivy-release-test/commit/6fafbeb60609a020b47266743250ea847234cbbd))
* **rust:** add cargo workspace members glob support ([#10032](https://github.com/aquasecurity/trivy-release-test/issues/10032)) ([d2dc46a](https://github.com/aquasecurity/trivy-release-test/commit/d2dc46ad60178371ff9e1099bc8cbe838e1190ad))
* **rust:** implement version inheritance for Cargo mono repos ([#10011](https://github.com/aquasecurity/trivy-release-test/issues/10011)) ([47d3103](https://github.com/aquasecurity/trivy-release-test/commit/47d3103c50d455df02c299d0f3e954b61e77fc8e))
* **sbom:** add `buildInfo` info as properties ([#9683](https://github.com/aquasecurity/trivy-release-test/issues/9683)) ([2c43425](https://github.com/aquasecurity/trivy-release-test/commit/2c43425e051d80d45169a2c675dba79caa91b1e7))
* **sbom:** add NOASSERTION for licenseDeclared/licenseConcluded in SPDX non-library packages ([#10368](https://github.com/aquasecurity/trivy-release-test/issues/10368)) ([33b9d8e](https://github.com/aquasecurity/trivy-release-test/commit/33b9d8ec318bb1f4081371a0a5fd46071080aef1))
* **sbom:** add support for `file` component type of `CycloneDX` ([#9372](https://github.com/aquasecurity/trivy-release-test/issues/9372)) ([aa7cf43](https://github.com/aquasecurity/trivy-release-test/commit/aa7cf4387c5e82c1f629ac14cd6a35b48fc95983))
* **sbom:** don’t panic on SBOM format if scanned CycloneDX file has empty metadata ([#9562](https://github.com/aquasecurity/trivy-release-test/issues/9562)) ([fb0593b](https://github.com/aquasecurity/trivy-release-test/commit/fb0593bee68a24b7ecddeb737e1d8e3c3a3c0364))
* **sbom:** merge in-graph and out-of-graph OS packages in scan results ([#9194](https://github.com/aquasecurity/trivy-release-test/issues/9194)) ([aa944cc](https://github.com/aquasecurity/trivy-release-test/commit/aa944cc6da43e2035f74e9d842f487c0d2f993f4))
* **sbom:** preserve Red Hat BuildInfo when scanning SBOMs without layer info ([#10378](https://github.com/aquasecurity/trivy-release-test/issues/10378)) ([e9e9e8c](https://github.com/aquasecurity/trivy-release-test/commit/e9e9e8c6bd914b4d4802107bbf8d0c40bad1dd57))
* **sbom:** remove unnecessary OS detection check in SBOM decoding ([#9034](https://github.com/aquasecurity/trivy-release-test/issues/9034)) ([198789a](https://github.com/aquasecurity/trivy-release-test/commit/198789a07b857b053c73f8fcd1f508902fac344d))
* **sbom:** use correct field for licenses in CycloneDX reports ([#9057](https://github.com/aquasecurity/trivy-release-test/issues/9057)) ([143da88](https://github.com/aquasecurity/trivy-release-test/commit/143da88dd82dfbe204f4c2afe46af3b01701675d))
* **secret:** add UTF-8 validation in secret scanner to prevent protobuf marshalling errors ([#9253](https://github.com/aquasecurity/trivy-release-test/issues/9253)) ([54832a7](https://github.com/aquasecurity/trivy-release-test/commit/54832a77b50e2da3a3ceacbb6ce1b13e45605cde))
* **secret:** fix line numbers for multiple-line secrets ([#9104](https://github.com/aquasecurity/trivy-release-test/issues/9104)) ([e579746](https://github.com/aquasecurity/trivy-release-test/commit/e57974649e4a3a275b9cf02db191b3f6bf10340f))
* **secret:** improve word boundary detection for Hugging Face tokens ([#10046](https://github.com/aquasecurity/trivy-release-test/issues/10046)) ([cdb28ee](https://github.com/aquasecurity/trivy-release-test/commit/cdb28eeeb176684e5b62b1bafbaf52e4cea79d4a))
* **server:** add HTTP transport setup to server mode ([#9217](https://github.com/aquasecurity/trivy-release-test/issues/9217)) ([1163b04](https://github.com/aquasecurity/trivy-release-test/commit/1163b044c7e91a81bba3a862cc4a38e90182f0b4))
* **server:** exclude JavaDB and CheckBundle from /version endpoint ([#10100](https://github.com/aquasecurity/trivy-release-test/issues/10100)) ([b9a8d2d](https://github.com/aquasecurity/trivy-release-test/commit/b9a8d2d80adc47bf9f48e13c2738b099c907518b))
* supporting .egg-info/METADATA in python.Packaging analyzer ([#9151](https://github.com/aquasecurity/trivy-release-test/issues/9151)) ([e306e2d](https://github.com/aquasecurity/trivy-release-test/commit/e306e2dc5275c0e75f056c8c7ee9ff9261c78e7f))
* suppress debug log for context cancellation errors ([#9298](https://github.com/aquasecurity/trivy-release-test/issues/9298)) ([2458d5e](https://github.com/aquasecurity/trivy-release-test/commit/2458d5e28a54da9adec0b36f6b1e6bd4f15a72ce))
* **terraform:** `for_each` on a map returns a resource for every key ([#9156](https://github.com/aquasecurity/trivy-release-test/issues/9156)) ([153318f](https://github.com/aquasecurity/trivy-release-test/commit/153318f65f7e5059bcc064bd2cd651cc720791a9))
* Trim the end-of-range suffix ([#9618](https://github.com/aquasecurity/trivy-release-test/issues/9618)) ([e18b038](https://github.com/aquasecurity/trivy-release-test/commit/e18b038ee2dce6c239246592fcef769853c11660))
* update all documentation links ([#9777](https://github.com/aquasecurity/trivy-release-test/issues/9777)) ([738b2b4](https://github.com/aquasecurity/trivy-release-test/commit/738b2b474a8ca94386a558c66442d8632acdce3c))
* update cosing settings for GoReleaser after bumping cosing to v3 ([#9863](https://github.com/aquasecurity/trivy-release-test/issues/9863)) ([c7accc8](https://github.com/aquasecurity/trivy-release-test/commit/c7accc85c66c27ec5c51b33acda97f4002cad584))
* update PhotonOS feed URL ([#10122](https://github.com/aquasecurity/trivy-release-test/issues/10122)) ([fa195b4](https://github.com/aquasecurity/trivy-release-test/commit/fa195b4d11d946b0212900b2a153a1abf381e8a2))
* Use `fetch-level: 1` to check out trivy-repo in the release workflow ([#9636](https://github.com/aquasecurity/trivy-release-test/issues/9636)) ([6e53686](https://github.com/aquasecurity/trivy-release-test/commit/6e53686526ef21e8a347fc07daa2f628e24eb9e5))
* use canonical SPDX license IDs from embeded licenses.json ([#10053](https://github.com/aquasecurity/trivy-release-test/issues/10053)) ([c233735](https://github.com/aquasecurity/trivy-release-test/commit/c233735b023974c0a5c321c370c7f3ebe5f20eec))
* use context for analyzers ([#9538](https://github.com/aquasecurity/trivy-release-test/issues/9538)) ([b885d3a](https://github.com/aquasecurity/trivy-release-test/commit/b885d3a3693a62bd2f506aeb238025242735ef1d))
* using SrcVersion instead of Version for echo detector ([#9552](https://github.com/aquasecurity/trivy-release-test/issues/9552)) ([66479f0](https://github.com/aquasecurity/trivy-release-test/commit/66479f050dc1f0faa314c5a4b9159f38bb1f146b))
* validate backport branch name ([#9548](https://github.com/aquasecurity/trivy-release-test/issues/9548)) ([f0fd432](https://github.com/aquasecurity/trivy-release-test/commit/f0fd432a7aeced7cca1acab5a52d72cd960e7171))
* **vex:** add CVE-2025-66564 as not_affected into Trivy VEX file ([#9924](https://github.com/aquasecurity/trivy-release-test/issues/9924)) ([335cc99](https://github.com/aquasecurity/trivy-release-test/commit/335cc993fa76cddf2e263cb8e09d0cbbb0b98a09))
* **vex:** don't  suppress vulns for packages with infinity loop ([#9465](https://github.com/aquasecurity/trivy-release-test/issues/9465)) ([78f0d4a](https://github.com/aquasecurity/trivy-release-test/commit/78f0d4ae0378f81940a5faa6497e6905cb5d034a))
* **vex:** don't use reused BOM ([#9604](https://github.com/aquasecurity/trivy-release-test/issues/9604)) ([7422cc7](https://github.com/aquasecurity/trivy-release-test/commit/7422cc7168ab917ec96b75de784be72e9b6bdb2e))
* **vex:** use a separate `visited` set for each DFS path ([#9760](https://github.com/aquasecurity/trivy-release-test/issues/9760)) ([c274f5b](https://github.com/aquasecurity/trivy-release-test/commit/c274f5b986afb82a805f1f6d3a79d44231a7edf6))
* **vuln:** compare `nuget` package names in lower case ([#9456](https://github.com/aquasecurity/trivy-release-test/issues/9456)) ([1ff9ac7](https://github.com/aquasecurity/trivy-release-test/commit/1ff9ac79488e0d4deab4226f1a969676a9851cdb))
* **vuln:** skip vulns detection for CentOS Stream family without scan failure ([#9964](https://github.com/aquasecurity/trivy-release-test/issues/9964)) ([b46cde0](https://github.com/aquasecurity/trivy-release-test/commit/b46cde0ebe651cfad461fcde510cfe8b847391c3))
* **wolfi:** support new APK database location ([#8937](https://github.com/aquasecurity/trivy-release-test/issues/8937)) ([b15d9a6](https://github.com/aquasecurity/trivy-release-test/commit/b15d9a60e6a3ed40811d5ca6387082266ae92ea7))


### Performance Improvements

* **misconf:** optimize string concatenation in azure scanner ([#9969](https://github.com/aquasecurity/trivy-release-test/issues/9969)) ([10a50a7](https://github.com/aquasecurity/trivy-release-test/commit/10a50a7429dd18377747c54db53fc68c376135d7))
* **plugin:** optimize directory traversal by replacing filepath.Walk with filepath.WalkDir ([#10325](https://github.com/aquasecurity/trivy-release-test/issues/10325)) ([d7fb355](https://github.com/aquasecurity/trivy-release-test/commit/d7fb3558db610dc08ef1c3e22dd37082180368b2))
* **secret:** only match secrets of meaningful length, allow example strings to not be matched ([#8602](https://github.com/aquasecurity/trivy-release-test/issues/8602)) ([60fef1b](https://github.com/aquasecurity/trivy-release-test/commit/60fef1b615a765248c5870b814ba0c4345220c0e))


### Code Refactoring

* **misconf:** use ID instead of AVDID for providers mapping ([#9752](https://github.com/aquasecurity/trivy-release-test/issues/9752)) ([6462dc8](https://github.com/aquasecurity/trivy-release-test/commit/6462dc8a5888003de0d08a5a2b2eb8ce464b6ae2))
